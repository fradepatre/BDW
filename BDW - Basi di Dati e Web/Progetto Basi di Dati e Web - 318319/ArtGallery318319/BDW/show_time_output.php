...
<html>
    ...
    $query = "SELECT artshow.Title, artshow.Type, artshow.Description, artshow.DateAndTime FROM artshow WHERE artshow.DateAndTime = '" . $time . "';";
    ...
    $result = $conn->query($query);
        ...
        while($row = $result->fetch_assoc()){
            ...
            echo "<br><br><h5>DateAndTime: </h5>";
            print_r($row["DateAndTime"]);
            echo "<br><br>";
            echo "-----------------------------------------------------------------------------------------------------------------------";
            }
        }
